...
it('returns arguments of arrow method', () => {
    ...
    const [value1, value2] = captureFirst(myClassMock).arrowMethod
...
it('setter', () => {
    ...
    const [value] = captureFirst(myClassMock).setProperty('myProperty')

    expect(value).toEqual('other value 1')
})
